          ...
          <div className="container text-center text-md-start mt-5">
            ...
            <div className="row mt-3">
              ...
              <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                {/* <!-- Links --> */}
                <h6 className="text fw-bold mb-4 footeffect  " style={{fontSize:"28px"}}>Quick Links</h6>
                <p >
              ...
              <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                {/* <!-- Links --> */}
                <h6  className="text fw-bold mb-4 footeffect" style={{fontSize:"28px"}}>Contact Us</h6>
                <p>
                  <a href="#!" className="text-reset" style={{textDecoration:"none"}}>
              ...
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4" >
                {/* <!-- Links --> */}
                <h6 className="text fw-bold mb-4 footeffect" style={{fontSize:"28px"}}>Stay Connected</h6>
                <p >
